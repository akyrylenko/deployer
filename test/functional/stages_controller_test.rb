...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { address: @stage.address, database_url: @stage.database_url, name: @stage.name }
    end
  ...
  test "should update stage" do
    put :update, id: @stage, stage: { address: @stage.address, database_url: @stage.database_url, name: @stage.name }
    assert_redirected_to stage_path(assigns(:stage))
  end
